...
public class Table_C extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_table__c);


        ImageView dot1 = (ImageView)findViewById(R.id.dot_1);
        ImageView dot2 = (ImageView)findViewById(R.id.dot_2);
        ImageView dot3 = (ImageView)findViewById(R.id.dot_3);





        mShakeAnimation = AnimationUtils.loadAnimation(Table_C.this,R.anim.shake_area);
        t = MediaPlayer.create(this,R.raw.closesound);
        touch = MediaPlayer.create(this,R.raw.touch);


        dot1.startAnimation(mShakeAnimation);
        dot2.startAnimation(mShakeAnimation);
        dot3.startAnimation(mShakeAnimation);
        ...
        howto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final SweetAlertDialog dialog = new SweetAlertDialog(Table_C.this,SweetAlertDialog.WARNING_TYPE);
        ...
        correct = MediaPlayer.create(Table_C.this,R.raw.chord_c);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Animatoo.animateSlideDown(Table_C.this);
                finish();
            }
        });
