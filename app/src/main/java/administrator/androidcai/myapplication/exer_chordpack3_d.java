...
public class exer_chordpack3_d extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exer_chordpack3_d);
        ...
        mShakeAnimation = AnimationUtils.loadAnimation(exer_chordpack3_d.this,R.anim.shake_area);
        ...
        correct = MediaPlayer.create(exer_chordpack3_d.this,R.raw.new_d);
        ...
        howto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final SweetAlertDialog dialog = new SweetAlertDialog(exer_chordpack3_d.this,SweetAlertDialog.WARNING_TYPE);
    ...
    public void openTable_CActivity(){
        Intent intent = new Intent(this, exer_chordpack3_em.class);
        startActivity(intent);
        Animatoo.animateFade(this);
        finish();
    }
