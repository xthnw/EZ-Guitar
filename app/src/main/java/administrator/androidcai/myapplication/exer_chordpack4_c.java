...
public class exer_chordpack4_c extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exer_chordpack4_c);
        ...
        mShakeAnimation = AnimationUtils.loadAnimation(exer_chordpack4_c.this,R.anim.shake_area);
        ...
        correct = MediaPlayer.create(exer_chordpack4_c.this,R.raw.chord_c);
        ...
        howto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final SweetAlertDialog dialog = new SweetAlertDialog(exer_chordpack4_c.this,SweetAlertDialog.WARNING_TYPE);
    ...
    public void openTable_CActivity(){
        Intent intent = new Intent(this, exer_chordpack4_am.class);
        startActivity(intent);
