...
public class exer_chordpack4_d extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mShakeAnimation = AnimationUtils.loadAnimation(exer_chordpack4_d.this,R.anim.shake_area);
        ...
        correct = MediaPlayer.create(exer_chordpack4_d.this,R.raw.new_d);
        ...
        howto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final SweetAlertDialog dialog = new SweetAlertDialog(exer_chordpack4_d.this,SweetAlertDialog.WARNING_TYPE);
