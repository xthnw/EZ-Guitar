...
public class exer_chordpack5_g extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exer_chordpack5_g);
        ...
        mShakeAnimation = AnimationUtils.loadAnimation(exer_chordpack5_g.this,R.anim.shake_area);
        ...
        correct = MediaPlayer.create(exer_chordpack5_g.this,R.raw.new_g);
        ...
        howto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final SweetAlertDialog dialog = new SweetAlertDialog(exer_chordpack5_g.this,SweetAlertDialog.WARNING_TYPE);
    ...
    public void openTable_CActivity(){
        Intent intent = new Intent(this, exer_chordpack5_d.class);
        startActivity(intent);
