...
public class exer_chordpack6_d extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exer_chordpack6_d);
        ...
        mShakeAnimation = AnimationUtils.loadAnimation(exer_chordpack6_d.this,R.anim.shake_area);

        dot_1.startAnimation(mShakeAnimation);
        dot_2.startAnimation(mShakeAnimation);
        dot_3.startAnimation(mShakeAnimation);

        correct = MediaPlayer.create(exer_chordpack6_d.this,R.raw.new_d);
        ...
        howto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final SweetAlertDialog dialog = new SweetAlertDialog(exer_chordpack6_d.this,SweetAlertDialog.WARNING_TYPE);
