...
public class exer_chordpack7_c extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exer_chordpack7_c);
        ...
        mShakeAnimation = AnimationUtils.loadAnimation(exer_chordpack7_c.this,R.anim.shake_area);

        dot_1.startAnimation(mShakeAnimation);
        dot_2.startAnimation(mShakeAnimation);
        dot_3.startAnimation(mShakeAnimation);

        correct = MediaPlayer.create(exer_chordpack7_c.this,R.raw.chord_c);
        ...
        howto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final SweetAlertDialog dialog = new SweetAlertDialog(exer_chordpack7_c.this,SweetAlertDialog.WARNING_TYPE);
    ...
    public void openTable_CActivity(){
        Intent intent = new Intent(this, exer_chordpack7_em.class);
        startActivity(intent);
