...
public class exer_chordpack8_em extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exer_chordpack8_em);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Animatoo.animateSlideDown(exer_chordpack8_em.this);
                finish();
            }
        });
        ...
        howto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final SweetAlertDialog dialog = new SweetAlertDialog(exer_chordpack8_em.this,SweetAlertDialog.WARNING_TYPE);
        ...
        mShakeAnimation = AnimationUtils.loadAnimation(exer_chordpack8_em.this,R.anim.shake_area);
        ...
        correct = MediaPlayer.create(exer_chordpack8_em.this, R.raw.new_em);
    ...
    public void opennext(){
        Intent intent = new Intent(this, exer_chordpack8_am.class);
        startActivity(intent);
