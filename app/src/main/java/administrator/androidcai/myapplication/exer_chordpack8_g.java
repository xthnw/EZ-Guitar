...
public class exer_chordpack8_g extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exer_chordpack8_g);
        ...
        mShakeAnimation = AnimationUtils.loadAnimation(exer_chordpack8_g.this,R.anim.shake_area);
        ...
        correct = MediaPlayer.create(exer_chordpack8_g.this,R.raw.new_g);
        ...
        howto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final SweetAlertDialog dialog = new SweetAlertDialog(exer_chordpack8_g.this,SweetAlertDialog.WARNING_TYPE);
