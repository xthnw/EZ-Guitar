...
public class game_chord_am extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game_chord_am);
       ...
       final TextView point = (TextView)findViewById(R.id.point);
        ...
        correct = MediaPlayer.create(game_chord_am.this, R.raw.chord_am);
    ...
    private void startCountdown() {
        ...
        countDownTimer = new CountDownTimer(timeleftInMillis,1000) {
            ...
            public void onFinish() {
                SweetAlertDialog dialog = new SweetAlertDialog(game_chord_am.this,SweetAlertDialog.ERROR_TYPE);
