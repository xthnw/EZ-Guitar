...
public class game_chord_d extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game_chord_d);
       ...
       final TextView point = (TextView)findViewById(R.id.point);
        ...
        chord=findViewById(R.id.im_chord_d);
        hand=findViewById(R.id.hand_d);
        t1=findViewById(R.id.howto_d);
        ...
        correct = MediaPlayer.create(game_chord_d.this,R.raw.new_d);
    ...
    private void startCountdown() {
        ...
        countDownTimer = new CountDownTimer(timeleftInMillis,1000) {
            ...
            public void onFinish() {
                SweetAlertDialog dialog = new SweetAlertDialog(game_chord_d.this,SweetAlertDialog.ERROR_TYPE);
