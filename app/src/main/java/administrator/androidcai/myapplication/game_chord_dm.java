...
public class game_chord_dm extends AppCompatActivity {
    ...
    public static final String TO_C = "com.example.application.example.EXTRA_INT";
    public static final String TO_AM = "com.example.application.example.EXTRA_INT";
    public static final String TO_DM = "com.example.application.example.EXTRA_INT";
    public static final String TO_G = "com.example.application.example.EXTRA_INT";
    public static final String TO_EM = "com.example.application.example.EXTRA_INT";
    public static final String TO_D = "com.example.application.example.EXTRA_INT";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game_chord_dm);
        ...
        chord=findViewById(R.id.im_chord_dm);
        t1=findViewById(R.id.howto_dm);
        t3=findViewById(R.id.hint);
        hand=findViewById(R.id.hand_dm);
        ...
        howto = findViewById(R.id.howto_dm);
        name_chord = findViewById(R.id.name_chord_dm);
        try_again = findViewById(R.id.try_again_dm);
        ...
        correct = MediaPlayer.create(game_chord_dm.this,R.raw.new_dm);
    ...
    private void startCountdown() {
        ...
        countDownTimer = new CountDownTimer(timeleftInMillis,1000) {
            ...
            public void onFinish() {
                SweetAlertDialog dialog = new SweetAlertDialog(game_chord_dm.this,SweetAlertDialog.ERROR_TYPE);
    ...
    public void openTable_CActivity(){
        Intent intent = new Intent(this, Table_G.class);
        startActivity(intent);
        Animatoo.animateSlideUp(this);
        finish();
    }
