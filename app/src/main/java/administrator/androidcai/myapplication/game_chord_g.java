...
public class game_chord_g extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game_chord_g);
        ...
        chord=findViewById(R.id.im_chord_g);
        t1=findViewById(R.id.howto_g);
        t3=findViewById(R.id.hint);
        hand=findViewById(R.id.hand_g);
        ...
        correct = MediaPlayer.create(game_chord_g.this,R.raw.new_g);
    ...
    private void startCountdown() {
        ...
        countDownTimer = new CountDownTimer(timeleftInMillis,1000) {
            ...
            public void onFinish() {
                SweetAlertDialog dialog = new SweetAlertDialog(game_chord_g.this,SweetAlertDialog.ERROR_TYPE);
