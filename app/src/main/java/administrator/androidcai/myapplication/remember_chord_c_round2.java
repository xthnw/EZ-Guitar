...
public class remember_chord_c_round2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_remember_chord_c_round2);
        ...
        c_but.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SweetAlertDialog dialog = new SweetAlertDialog(remember_chord_c_round2.this,SweetAlertDialog.SUCCESS_TYPE);
                dialog.getWindow(). setFlags(WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE,
                        WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE);
                dialog.setTitleText("You are Good !");
        ...
        am_but.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                am_but.setEnabled(false);
                new SweetAlertDialog(remember_chord_c_round2.this,SweetAlertDialog.ERROR_TYPE).setTitleText("WRONG").setConfirmText("OK")
                        .setContentText("is not bad, Just try again")
    ...
    public void openest(){
        Intent intent = new Intent(this, remember_chord_dm.class);
